...
export const metadata = { title: '이용약관 — SecureAI' };

export default function TermsPage() {
  return (
    <LegalPageShell title="이용약관" updated="2026-05-30">
      <h2 style={legalH2}>제1조 (목적)</h2>
      <p>본 약관은 SecureAI(이하 &ldquo;회사&rdquo;)가 제공하는 AI 기반 보안 분석 서비스(이하 &ldquo;서비스&rdquo;)의 이용과 관련하여 회사와 이용자 간의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.</p>
